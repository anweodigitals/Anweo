...
function Services() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "bg-ink text-bone px-6 lg:px-10 py-20 lg:py-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1600px] mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { className: "flex flex-wrap items-end justify-between gap-6 mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-sm text-bone/60", children: "Everything a modern café, salon, boutique or service business needs to look premium online — without juggling four different freelancers." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 border-t border-bone/15", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "lg:col-span-7 divide-y divide-bone/15", children: services.map((s, i) => {
          ...
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-6 py-8 lg:py-10 transition-all", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-bone/40", children: s.id }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                    className: `display text-4xl lg:text-7xl transition-all duration-500 ${isActive ? "text-ember translate-x-3" : "text-bone"}`,
                    children: s.name
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `ml-auto text-2xl transition-all duration-500 ${isActive ? "rotate-45 text-ember" : "rotate-0 text-bone/40"}`,
                    children: "+"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-10 lg:pl-12 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-bone/70 leading-relaxed", children: s.blurb }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1 font-mono text-xs uppercase tracking-widest text-bone/60", children: s.deliverables.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex lg:col-span-4 lg:col-start-9 sticky top-32 self-start flex-col gap-6 pt-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-bone/50", children: "Engagement model" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 mt-4 pt-6 border-t border-bone/15", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "display text-4xl", children: "14d" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-bone/50 mt-1", children: "Typical launch" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "display text-4xl", children: "1:1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-bone/50 mt-1", children: "Founder access" })
          ] })
        ] })
      ] })
    ] })
