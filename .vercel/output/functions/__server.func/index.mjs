...
import { a as FastResponse, t as toNodeHandler } from "./_libs/srvx.mjs";
...
const _lazy__RPxH5 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy__RPxH5 };
  return ((_m, p) => {
